...
public class HomeController {
	...
	public String login(@AuthenticationPrincipal OidcUser principal, Model model,
	...
	public String information(Authentication authentication, Model model) {
		// Hàm dưới đây kiểm tra username của người dùng trong trang information cho
		// đăng nhập bằng gg và cách thường
